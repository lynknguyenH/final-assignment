...
public class BasePage {
    ...
    public boolean isElementUndisplayed(WebDriver driver, String locator) {
        ...
        if (listElement.size() == 0) {
            Log.allure("Element is not in DOM");
            return true;
        } else if (!listElement.isEmpty() && !listElement.get(0).isDisplayed()) {
            Log.allure("Element in DOM but undisplayed");
            return true;
        } else {
            Log.allure("Element is in DOM and display");
            return false;
        }
    }
    public boolean isElementUndisplayed(WebDriver driver, String locator, String... params) {
        ...
        if (listElement.size() == 0) {
            ...
            Log.allure("Element is in DOM but undisplayed");
            return true;
        } else {
            Log.allure("Element is in DOM and display");
            return false;
...
//
    ...
    protected boolean isSorted(List<String> list) {
